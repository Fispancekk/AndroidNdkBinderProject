...
public:
    ...
    {
        LOGD("Ewanr %d", AParcel_getDataPosition(pParcel));

        int32_t iNotNull;
        AParcel_readInt32(pParcel, &iNotNull);
        LOGD("Ewanr2 %d", AParcel_getDataPosition(pParcel));
    ...
    {
        LOGD("Ewanw %d", AParcel_getDataPosition(pParcel));

        int32_t iNotNull = 1;
        AParcel_writeInt32(pParcel, iNotNull);
        LOGD("Ewanw2 %d", AParcel_getDataPosition(pParcel));
